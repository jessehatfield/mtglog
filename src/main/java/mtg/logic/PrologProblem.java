...
public class PrologProblem {
     ...
     */
    public static PrologProblem fromYaml(final String filename) throws IOException {
     ...
     * @return The corresponding hand evaluation problem specification
     */
    public static PrologProblem fromYaml(final InputStream is) {
        Objects.requireNonNull(is);
        final Yaml yaml = new Yaml(new Constructor(PrologProblem.class));
        PrologProblem spec = yaml.load(is);
        return spec;
    }
}
