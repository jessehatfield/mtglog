...
protected_win(HAND, DECK, SB, MIN_PROTECTION, TARGET_PROTECTION, SEQUENCE, BEST_PROTECTION) :-
    ...
    protected_win(HAND, DECK, SB, MIN_PROTECTION, NEW_TARGET, SEQUENCE, BEST_PROTECTION).
protected_win(HAND, DECK, SB, SEQUENCE, PROTECTION) :-
    protected_win(HAND, DECK, SB, 0, 3, SEQUENCE, PROTECTION).
...
win(HAND, DECK, SB, SEQUENCE, PROTECTION) :-
    ...
    etw(HAND, DECK, SEQUENCE, STORM, PROTECTION), STORM >= 5;
    belcher(HAND, DECK, SEQUENCE, PROTECTION);
    wish_warrens(HAND, DECK, SB, SEQUENCE, STORM, PROTECTION), STORM >= 5;
