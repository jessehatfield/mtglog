...
test_car :-
    format("\nTest hands involving The Fantasticar.\n", []),
    PetalsCar = ['Lotus Petal', 'Lotus Petal', 'Lotus Petal', 'The Fantasticar'],
    not(hand_wins_(PetalsCar, [], [], 0, 0, _)),
    hand_wins_(['Mountain' | PetalsCar], [], [], 0, 0, 'The Fantasticar'),
    TombGrimCar = ['Grim Monolith', 'Ancient Tomb', 'The Fantasticar'],
    not(hand_wins_(TombGrimCar, [], [], 0, 0, _)),
    not(hand_wins_(['Mox Opal' | TombGrimCar], [], [], 0, 0, _)),
    not(hand_wins_(['Shield Sphere' | ['Mox Opal' | TombGrimCar]], [], [], 0, 0, _)),
    hand_wins_(['Mox Opal' | ['Mox Opal' | TombGrimCar]], [], [], 0, 0, 'The Fantasticar'),
    AffinityHand = ['Mox Opal' | ['Shield Sphere' | ['Thoughtcast' | TombGrimCar ]]],
    hand_wins_(AffinityHand, [], [], 0, 0, 'The Fantasticar'),
    RiteHand = ['Rite of Flame', 'Rite of Flame', 'The Fantasticar'],
    not(hand_wins_(RiteHand, [], [], 0, 0, _)),
    not(hand_wins_(['Lotus Petal' | RiteHand], [], [], 0, 0, _)),
    not(hand_wins_(['Mountain' | RiteHand], [], [], 0, 0, _)),
    not(hand_wins_(['Lotus Petal' | ['Pithing Needle' | RiteHand]], [], [], 0, 0, _)),
    not(hand_wins_(['Mountain' | ['Ornithopter' | RiteHand]], [], [], 0, 0, _)),
    not(hand_wins_(['Mountain' | ['Summoner\'s Pact' | RiteHand]], [], [], 0, 0, _)),
    hand_wins_(['Mountain' | ['Pithing Needle' | RiteHand]], [], [], 0, 0, 'The Fantasticar'),
    SongHand = ['Defense Grid', 'The Fantasticar', 'Seething Song', 'City of Traitors'],
    hand_wins_(['Lotus Petal' | SongHand], [], [], 0, 0, 'The Fantasticar'),
    not(hand_wins_(['Simian Spirit Guide' | SongHand], [], [], 0, 0, 'The Fantasticar')),
    hand_wins_(['Urza\'s Bauble' | ['Simian Spirit Guide' | SongHand]], [], [], 0, 1, 'The Fantasticar'),
    BeseechHand = ['Beseech the Mirror', 'Dark Ritual', 'Vault of Whispers'],
    not(hand_wins_(['Lotus Petal' | BeseechHand], ['The Fantasticar'], [], 0, 0, _)),
    not(hand_wins_(['Simian Spirit Guide' | BeseechHand], ['The Fantasticar'], [], 0, 0, _)),
    not(hand_wins_(['Mishra\'s Bauble' | ['Simian Spirit Guide' | BeseechHand]], [], [], 0, 0, _)),
    hand_wins_(['Mishra\'s Bauble' | ['Simian Spirit Guide' | BeseechHand]], ['The Fantasticar'], [], 0, 0, _),
    UnmaskHand = ['The Fantasticar', 'Unmask', 'Dark Ritual', 'Swamp', 'Urza\'s Bauble'],
    not(hand_wins_(UnmaskHand, [], [], 0, _, _)),
    hand_wins_(['Bridge from Below' | UnmaskHand], [], [], 0, 1, 'The Fantasticar'),
    not(hand_wins_(['Bridge from Below', 'The Fantasticar', 'Grief', 'Dark Ritual', 'Swamp', 'Urza\'s Bauble'], [], [], 0, _, _)),
    DuressHand = ['Dark Ritual', 'The Fantasticar', 'Swamp', 'Duress', 'Urza\'s Bauble'],
    hand_wins_(['Dark Ritual' | DuressHand], [], [], 0, 0, 'The Fantasticar'),
    hand_wins_(['Simian Spirit Guide' | DuressHand], [], [], 0, 1, 'The Fantasticar'),
    LEDHand = ['Lion\'s Eye Diamond', 'The Fantasticar', 'Swamp', 'Dark Ritual'],
    not(hand_wins_(LEDHand, [], [], 0, _, _)),
    not(hand_wins_(['Cabal Therapy' | LEDHand], [], [], 0, _, _)),
    hand_wins_(['Cabal Therapy' | ['Ornithopter' | LEDHand]], [], [], 0, 0, 'The Fantasticar'),
    hand_wins_(['Mishra\'s Bauble' | LEDHand], [], [], 0, 0, 'The Fantasticar'),
    hand_wins_(['Lingering Souls' | LEDHand], [], [], 0, 0, 'The Fantasticar'),
    hand_wins_(['Echo of Eons' | LEDHand], [], [], 0, 0, 'The Fantasticar').
